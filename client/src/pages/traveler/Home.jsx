...
import { TOURS, seatsFor } from '../../data/traveler/tours';
...
const ACTOR_TILES = [
  { code: 'TRV', title: 'Travellers', meta: 'Book trips and stays', verb: 'Search' },
  { code: 'OPR', title: 'Tour Operators', meta: 'Sell your itineraries', verb: 'Apply' },
  { code: 'TRN', title: 'Transporters', meta: 'Jeeps and coasters', verb: 'Apply' },
  { code: 'PRP', title: 'Hotels & Restaurants', meta: 'Rooms and tables', verb: 'Apply' },
  { code: 'SLR', title: 'Marketplace Sellers', meta: 'Ship gear anywhere', verb: 'Apply' },
  { code: 'INF', title: 'Influencers', meta: 'Collaborate and earn', verb: 'Join' },
];

// Live numbers the same store the booking, payout and stock screens read —
// stubbed locally until those modules are wired.
const LIVE = { seats: seatsFor('hunza'), stock: 6, quotes: 2, rooms: 14, referral: 5922, commissionPct: 12, referralPct: 4 };
...
const ROAD = [
  {
    ...
    stat: `${LIVE.seats} seats left on Hunza today`, cta: 'See the live search', href: '/discover/search',
  },
  {
    ...
    stat: `Operators keep ${100 - LIVE.commissionPct}% of every booking`, cta: 'Open an operator dashboard', href: '/vendor/dashboard',
  },
  {
    ...
    stat: `${LIVE.quotes} quote requests open right now`, cta: 'Open the quote inbox', href: '/transport/quotes',
  },
  {
    ...
    stat: `${LIVE.rooms} rooms live tonight`, cta: 'See the room manager', href: '/discover/property',
  },
  {
    ...
    stat: `${LIVE.stock} down jackets in stock right now`, cta: 'Watch stock on the shelf', href: '/shop/seller-products',
  },
  {
    ...
    stat: `Rs ${LIVE.referral.toLocaleString('en-US')} commission accruing at ${LIVE.referralPct}%`,
        ...
        <div className="flex flex-col justify-center gap-5 py-1">
          ...
          <div className="grid grid-cols-1 items-end gap-2.5 rounded-2xl border border-border bg-surface p-3 shadow-sh2 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex min-h-[46px] items-center gap-1 rounded-lg border border-border-strong bg-raised px-1.5">
                <button
                  type="button"
                  onClick={() => setGuests((g) => Math.max(1, g - 1))}
                  aria-label="One fewer traveller"
                  className="h-9 w-9 flex-none rounded-md border border-border bg-surface text-lg text-fg"
                >
                  −
                </button>
            ...
            <button
              type="button"
              onClick={doSearch}
              className="min-h-[46px] rounded-lg bg-primary text-[15px] font-bold text-primary-on"
            >
              Search {TOURS.length} trips
            </button>
          </div>
