...
export const ROLES = [
  ...
  { id: 'transport', label: 'Transport owner', nav: [['Vehicles', '/transport/vehicles'], ['Quotes', '/transport/quotes'], ['Permits', '/transport/permits'], ['Money', '/transport/money']] },
  ...
  { id: 'seller', label: 'Gear seller', nav: [['Products', '/shop/seller-products'], ['Orders', '/shop/fulfilment'], ['Returns', '/shop/returns'], ['Money', '/shop/seller-payouts']] },
