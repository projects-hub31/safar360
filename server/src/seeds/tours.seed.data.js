// Data + the departure-generation helper for tours.seed.js, split out so the
// same rows are reusable from a test harness without re-running the
// connect/upsert/exit script. See tours.seed.js for the "why transcribed by
// hand" note (client/src/data/traveler/tours.js is an ES module that imports
// .jpg assets — can't require() it from here).
function departuresFor(seatsLeft, groupMax) {
  const total = Math.max(seatsLeft, groupMax);
  const soon = new Date(Date.now() + 18 * 86400000);
  const later = new Date(Date.now() + 45 * 86400000);
  return [
    { date: soon, note: "Next departure", seatsTotal: total, seatsLeft },
    { date: later, note: "Following departure", seatsTotal: groupMax, seatsLeft: groupMax },
  ];
}

const TOURS = [
  {
    slug: "hunza", title: "Hunza & Attabad Lake — 5 days", img: "/images/tours/hunza.jpg",
    alt: "Turquoise Attabad Lake below terraced slopes", region: "Gilgit-Baltistan", days: 5,
    price: 56625, rating: 4.9, reviews: 184, operator: "Karakoram Expeditions",
    meta: "Karimabad · Attabad · Passu · 5 days", badge: "Editor's pick", sponsored: false,
    bookingMode: "instant", cancellationPolicy: "standard", groupMax: 12, seatsLeft: 7,
  ...
  {
    slug: "skardu", title: "Skardu, Shangrila & Deosai — 7 days", img: "/images/tours/skardu.jpg",
    alt: "Braided river valley near Skardu", region: "Gilgit-Baltistan", days: 7,
    price: 84000, rating: 4.8, reviews: 132, operator: "Baltistan Trails",
    meta: "Skardu · Shangrila · Deosai plains · 7 days", badge: "", sponsored: false,
    bookingMode: "instant", cancellationPolicy: "standard", groupMax: 14, seatsLeft: 12,
  ...
  {
    slug: "fairy", title: "Fairy Meadows & Nanga Parbat base — 4 days", img: "/images/tours/fairy.jpg",
    alt: "Alpine meadow beneath a snow face", region: "Gilgit-Baltistan", days: 4,
    price: 48500, rating: 4.7, reviews: 97, operator: "Raikot Guides",
    meta: "Raikot bridge · Tato jeep track · base camp · 4 days", badge: "Hard trek", sponsored: false,
    bookingMode: "request", cancellationPolicy: "strict", groupMax: 10, seatsLeft: 3,
  ...
  {
    slug: "kumrat", title: "Kumrat Valley & Jahaz Banda — 3 days", img: "/images/tours/kumrat.jpg",
    alt: "Pine forest along a river in Kumrat", region: "Khyber Pakhtunkhwa", days: 3,
    price: 31200, rating: 4.6, reviews: 211, operator: "Dir Valley Tours",
    meta: "Thal · Kumrat forest · Jahaz Banda · 3 days", badge: "", sponsored: true,
    bookingMode: "instant", cancellationPolicy: "flexible", groupMax: 16, seatsLeft: 12,
  ...
  {
    slug: "kkh", title: "Karakoram Highway to Khunjerab — 6 days", img: "/images/tours/kkh.jpg",
    alt: "Highway curving between bare mountains", region: "Gilgit-Baltistan", days: 6,
    price: 72400, rating: 4.8, reviews: 156, operator: "Silk Route Motors",
    meta: "Gilgit · Sost · Khunjerab Pass 4,693 m · 6 days", badge: "", sponsored: false,
    bookingMode: "instant", cancellationPolicy: "standard", groupMax: 12, seatsLeft: 9,
  ...
  {
    slug: "deosai", title: "Deosai Plains camping — 3 days", img: "/images/tours/deosai.jpg",
    alt: "Open high plateau under cloud", region: "Gilgit-Baltistan", days: 3,
    price: 38900, rating: 4.5, reviews: 74, operator: "Baltistan Trails",
    meta: "Sheosar Lake · Bara Pani · 3 days", badge: "", sponsored: false,
    bookingMode: "instant", cancellationPolicy: "standard", groupMax: 14, seatsLeft: 5,
  ...
  {
    slug: "gwadar", title: "Gwadar & the Makran coast — 4 days", img: "/images/tours/gwadar.jpg",
    alt: "Cliffs above a turquoise coastline", region: "Balochistan", days: 4,
    price: 44600, rating: 4.4, reviews: 38, operator: "Makran Coastal Tours",
    meta: "Hingol · Kund Malir · Princess of Hope · 4 days", badge: "New", sponsored: true,
    bookingMode: "instant", cancellationPolicy: "flexible", groupMax: 18, seatsLeft: 12,
  ...
  {
    slug: "kalash", title: "Kalash valleys, Chitral — 5 days", img: "/images/tours/kalash.jpg",
    alt: "Terraced valley village in autumn", region: "Khyber Pakhtunkhwa", days: 5,
    price: 59800, rating: 4.7, reviews: 89, operator: "Chitral Heritage Travel",
    meta: "Bumburet · Rumbur · Birir · 5 days", badge: "", sponsored: false,
    bookingMode: "instant", cancellationPolicy: "standard", groupMax: 10, seatsLeft: 8,
  ...
  {
    slug: "passu", title: "Passu Cones & Borith Lake — 2 days", img: "/images/tours/passu.jpg",
    alt: "Jagged rock spires above a glacier", region: "Gilgit-Baltistan", days: 2,
    price: 23400, rating: 4.6, reviews: 143, operator: "Gojal Adventure Co.",
    meta: "Hussaini bridge · Borith · Passu glacier · 2 days", badge: "", sponsored: false,
    bookingMode: "instant", cancellationPolicy: "standard", groupMax: 12, seatsLeft: 2,
  ...
  {
    slug: "lake", title: "Naltar valley & coloured lakes — 3 days", img: "/images/tours/lake.jpg",
    alt: "Still alpine lake ringed by conifers", region: "Gilgit-Baltistan", days: 3,
    price: 34500, rating: 4.5, reviews: 66, operator: "Gojal Adventure Co.",
    meta: "Naltar Bala · blue lake · Pakora · 3 days", badge: "", sponsored: false,
    bookingMode: "instant", cancellationPolicy: "standard", groupMax: 12, seatsLeft: 11,
...
module.exports = { TOURS, departuresFor };
